  ...
  <nav class="header">
    ...
    <ul class="menu">
      <li><nuxt-link
        ...
        :class="{ selected: $route.path === localePath('index') }"><span>{{ $t('page.mySushi') }}</span></nuxt-link></li>
      <li><nuxt-link
        :to="localePath('market')"
        class="nav-button"
        @click.native="onClickLink"
        :class="{ selected: $route.path === localePath('market') }"><span>{{ $t('page.market') }}</span></nuxt-link></li>
      <li><nuxt-link
        :to="localePath('all-sushi')"
        class="nav-button"
        @click.native="onClickLink"
        :class="{ selected: $route.path === localePath('all-sushi') }"><span>{{ $t('page.allSushi') }}</span></nuxt-link></li>
    </ul>
    <nuxt-link
      class="language"
